...
| download_artifacts    |          | bool                     | false                 | Indicates whether the created artifacts and logs from runs, pipelines and steps should be downloaded to your GitHub workspace. This only works if `wait_for_completion` is set to true. |
